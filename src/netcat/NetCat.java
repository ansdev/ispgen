...
public class NetCat {
	...
	public static void push(String host, int port, String message) throws Exception{
		//System.err.println("Connecting to " + host + " port " + port);
		final Socket socket = new Socket(host, port);
		pushStreams(socket,message);
	}
	...
	private static void pushStreams(Socket socket, String message) throws IOException,
		InterruptedException {
		InputStream is = new ByteArrayInputStream(message.getBytes());
		InputStream input1 = is;
